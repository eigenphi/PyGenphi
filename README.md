...
pipenv shell
# install PyGenphi
pipenv install PyGenphi==0.2.10
```

Note: run command `pipenv install PyGenphi==0.2.10` within existing `PyGenphiDemo` directory with lower version of PyGenphi will auto upgrade PyGenphi to v0.2.10
